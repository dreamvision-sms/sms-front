...
import TextFieldFormik from '../components/Forms/TextFieldFormik';
import { useFormik } from 'formik';
import * as Yup from 'yup';
import { BiPhoneCall } from 'react-icons/bi';
import { TfiEmail } from 'react-icons/tfi';

import BackendEmailForm from '../components/Settings/forms/BackendEmailForm';
              ...
              <form onSubmit={formik.handleSubmit}>
                <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                  <TextFieldFormik
                    ...
                    {...formik.getFieldProps('school_name')} // Spread getFieldProps('name') props
                    name="school_name"
                    label="Nom"
                    ...
                    error={
                      formik.touched.school_name
                        ? formik.errors.school_name?.toString()
                        : ''
                    }
                  />
                  ...
                  <TextFieldFormik
                    Icon={BiPhoneCall}
                    {...formik.getFieldProps('phone')} // Spread getFieldProps('phone') props
                    name="phone"
                ...
                <TextFieldFormik
                  Icon={TfiEmail}
                  {...formik.getFieldProps('email')} // Spread getFieldProps('phone') props
                  name="email"
                  label="Adresse mail"
